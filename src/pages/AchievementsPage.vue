...
function iconSvg(name: IconName) {
  switch (name) {
    ...
    case 'controller':
      return '<svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor"><path d="M7 8l-2.5 5.5A2.5 2.5 0 0 0 6.8 17H9l2-2h2l2 2h2.2a2.5 2.5 0 0 0 2.3-3.5L17 8H7z"/></svg>'
    case 'clapper':
      return '<svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor"><path d="M4 4h3l2 4H6zM9 4h3l2 4h-3zM14 4h3l2 4h-3zM3 10h18v9H3z"/></svg>'
    case 'crown':
      return '<svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor"><path d="M3 7l3 4 4-6 4 6 3-4 3 10H3z"/></svg>'
    case 'fire':
      return '<svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor"><path d="M13 3s-1 2-1 4a3 3 0 0 0-3-3c0 4-3 5-3 9a7 7 0 0 0 14 0c0-4-3-6-3-10-2 0-3 2-4 4 0-2-0.5-3.5-1-4z"/></svg>'
    case 'medal':
      return '<svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor"><path d="M7 2h4l1 3 1-3h4l-3 6a5 5 0 1 1-4 0z"/></svg>'
    case 'ticket':
      return '<svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor"><path d="M4 7h16v3a2 2 0 0 0 0 4v3H4v-3a2 2 0 0 0 0-4z"/></svg>'
    case 'popcorn':
      return '<svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor"><path d="M7 5a3 3 0 0 1 5-2 3 3 0 0 1 5 2 2 2 0 0 1 1 2l-2 11H8L6 7a2 2 0 0 1 1-2z"/></svg>'
  }
}
</script>
